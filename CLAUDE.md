...
| `engine/exam_engine/schemas/canonical-question.schema.json` | The canonical JSON Schema (currently **v1.3.0**) — single source of truth. **Package data** (KAN-258): ships in the wheel, resolved package-relative (env override `EXAM_SCHEMA_PATH`). |
