...
> **Where this sits:** the problem space is defined (`docs/REQS.md`, `QUESTIONS.md`)
...
> `docs/adr/*`, `docs/SCHEMA.md`, `docs/DIFFICULTY.md`, `CONTEXT.md` (glossary).

---

## Frame

- **Source** (verbatim): `chatgpt-conversation-summary.md`, `docs/REQS.md`.
