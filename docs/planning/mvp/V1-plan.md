...
> **Slice V1 of `docs/planning/mvp/SLICES.md`.** The thinnest full-stack path that produces a
> question a teacher can trust. Ground truth for R and Shape A: `docs/planning/mvp/SHAPING.md`.
